...
if src == "ipinyou":
  camps = config.ipinyou_camps  # ["1458", "2259", "2261", "2821", "2997", "3358", "3386", "3427", "3476"]
  data_path = config.ipinyouPath # ../data/ipinyou-data/
  max_market_price = config.ipinyou_max_market_price # 300
elif src == "vlion":
...
for camp in camps:
  camp_info = config.get_camp_info(camp, src) # pickle.load("../data/ipinyou-data/"+camp+"info.txt")
